...
*/
define("HTTP", "http://");
define("HTTP_HOST", $_SERVER["HTTP_HOST"] . '/livework/smighties');
define("ROOT_PATH", $_SERVER['DOCUMENT_ROOT'] . '/livework/smighties/');
...
define("BOWER_PATH", ROOT_PATH . "/classes");
/*
|--------------------------------------------------------------------------
| 	Site assets Paths
|--------------------------------------------------------------------------
...
define("AVATAR_TEMP_UP_PATH", ROOT_PATH . "/images/avatar/temp");
define("AVATAR_SHOW_PATH", HTTP . HTTP_HOST . "/images/avatar");
