      ...
      <div class="container-fluidic container-tv-header">
          ...
          <div class="container">
              ...
              <div class="page-title">
                <h1 class="grd-txt"><button onclick="javascript: window.location.href='<?php echo HOST_URL?>/news'" type="button" class="button-news-close"></button> Watch the Trailer For ‘Ferdinand’</h1>
                <h2 style="padding-left: 70px;">Posted on 29 Mar by Administrator</h2>
