<?php if($records):?>
    <?php foreach ($records as $key => $value):?>
        ...
        <a class="hvr-grow col-lg-3 col-xs-6 col-sm-6 col-md-3 smighty-item" data-toggle="modal" data-target="#profileModal" href="<?php echo HOST_URL?>/async/smighty-profile/<?php echo $value->id?>">
