...
class News extends Admin_Controller {
    ...
    protected $className;
    public $imageUpPath = NEWS_UP_PATH;
    public $imageShowPath = NEWS_SHOW_PATH;

    public function __construct() {

        parent::__construct();
        $this->viewFolder = ADMIN_VIEWS . '/news';
        $this->data['menuActive'] = 'news';
        $this->data['ctrlUrl'] = HOST_URL . "/" . ADMIN_URL . "/News";
        $this->load->model( ADMIN_VIEWS . '/model_news', 'modelNameAlias');
        $this->className = 'News';
    }
    ...
    public function edit($id) {
        ...
        $this->data['imageShowPath'] = $this->imageShowPath."/hd";
