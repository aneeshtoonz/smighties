...
class Gaming extends Admin_Controller {
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->viewFolder = ADMIN_VIEWS . '/gaming';
        $this->data['menuActive'] = 'gaming';
        $this->data['ctrlUrl'] = HOST_URL . "/" . ADMIN_URL . "/Gaming";
        $this->load->model( ADMIN_VIEWS . '/model_gaming_query', 'modelNameAlias');

        $this->className = 'Gaming';
    ...
    public function site_traffic() {
        ...
        $this->load->model( ADMIN_VIEWS. '/model_gaming_views', 'modelTrafficAlias');
