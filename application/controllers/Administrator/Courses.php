...
class Courses extends Admin_Controller {
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->viewFolder = ADMIN_VIEWS . '/courses';
        $this->data['menuActive'] = 'courses';
        $this->data['ctrlUrl'] = HOST_URL . "/" . ADMIN_URL . "/Courses";
        $this->load->model( ADMIN_VIEWS . '/model_courses', 'modelNameAlias');
    ...
    public function site_traffic() {
        ...
        $this->load->model( ADMIN_VIEWS. '/model_courses_traffic', 'modelTrafficAlias');
    ...
    public function export() {
          ...
          //name the worksheet
          $this->excel->getActiveSheet()->setTitle('Courses LP');
